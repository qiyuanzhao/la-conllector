package com.lavector.collector.crawler.project.game.overwatch.weibo.page;
 ...
 * @author zeng.zhao
 */
public class WeiBoHomePage implements PageParse {

    @Override
    public boolean handleUrl(String url) {
        return url.equals("http://weibo.com/blizzoverwatch?refer_flag=1001030101_&is_all=1");
    }
...
//            }
    ...
    public static void main (String[] args) throws Exception {
        String url = "http://weibo.com/blizzoverwatch?refer_flag=1001030101_&is_all=1";
        ...
        WeiBoHomePage weiBoHomePage = new WeiBoHomePage();
        weiBoHomePage.parse(page);
    }
}
