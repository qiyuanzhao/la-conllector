 ...
 * @author zeng.zhao
 */
@Service(CrawlerType.QQ_SPORT_FOOTBALL)
@Scope(ConfigurableBeanFactory.SCOPE_PROTOTYPE)
public class TencentFootballCrawler extends BaseCrawler {
    @Override
    protected MySpider createSpider(CrawlerInfo crawlerInfo) {
        MySpider spider = MySpider.create(new TencentFootballPageProcessor(crawlerInfo));
        spider.thread(2);
